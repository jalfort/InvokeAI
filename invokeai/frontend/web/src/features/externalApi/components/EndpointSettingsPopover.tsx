...
import { useDeleteDynamicEndpointMutation, useUpdateDynamicEndpointMutation } from 'services/api/endpoints/externalApi';
...
export const EndpointSettingsPopover = memo(
  ({ endpoint, apiCategorySuggestions, customCategorySuggestions }: Props) => {
    ...
    const handleSave = useCallback(async () => {
      ...
      if (
        ...
        updates.api_category !== undefined ||
        updates.user_category !== undefined
      ) {
