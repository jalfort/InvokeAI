...
export const prepareCanvasComposite = async (manager: CanvasManager, rect: Rect): Promise<ImageDTO | null> => {
  ...
  // P4: overlay annotations (text, arrows, shapes) here once the annotation layer lands.
  // Until then the composite is the raster-only flatten (annotation tool not yet ported).
